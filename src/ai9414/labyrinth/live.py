"""Live-solver wiring for the labyrinth DFS demo."""
...
def _load_stub() -> str:
    return resources.files("ai9414.labyrinth.templates").joinpath("solve_labyrinth.py").read_text(encoding="utf-8")
...
def build_live_spec() -> LiveSpec:
    return LiveSpec(
        ...
        build_trace=lambda lab, result: build_labyrinth_trace_from_result(lab, result, app_type="labyrinth"),
    )
